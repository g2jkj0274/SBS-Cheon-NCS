    ...
    <section className="benefits-section" id="benefits">
      <div className="section-inner">
        ...
        <p className="sec-desc">
          단순 문법 학습이 아니라 실무 프로젝트 완성을 목표로, 취업과 포트폴리오에 연결될 수 있는 흐름으로 구성했습니다.
        </p>
